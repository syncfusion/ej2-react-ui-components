...
The Splitter is layout user interface (UI) which contains multiple resizable panes and separator bar.

- **Resizable**: All the panes configured with resizable by default.
